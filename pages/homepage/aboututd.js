  ...
  return (
    <div className="flex flex-col items-center w-screen bg-utd-red" id="venue">
      <div className="bg-white text-black m-8 sm:m-16 rounded-xl">
        {" "}
        <h2 className="text-center uppercase font-extrabold px-4 py-8 text-lg md:text-xl lg:mx-80">
          2024 - the inaugural year for Under the Drum Festival{" "}
        </h2>
        <p className="text-center px-4 pt-8 text-lg md:text-xl lg:mx-80 text-black">
          {" "}
        ...
        <p className="text-center px-4 py-8 text-lg md:text-xl lg:mx-80 text-black">
